...
class TestAuth:
    @pytest.mark.localAdminAuth
    def test_verify_local_admin_login(self, driver, url):
    ...
    def test_verify_signup_func_in_local_user_auth(self, driver, url):
        ...
        Platform(driver).launch(url) \
            ...
            .click_close_button() \
            .logout() \
            .login(prefix + "test@putsbox.com", "123qweA!") \
            .verify_user_profile_item_present()

    @pytest.mark.localPerfAuth
    def test_verify_local_auth_performance(self, driver, url):
        print("To verify Administrator login")
        Platform(driver).launch(url) \
            .login_as_admin() \
