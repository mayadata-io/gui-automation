...
class TestTeaming:
    ...
    # Tests to verify invite functionality
    ...
    # Tests to verify user role update functionality
    ...
    # Tests to verify user role update by non project owner negative
    @pytest.mark.teamingRoleUpdateNegative
    def test_verify_user_role_update_by_admin_user_negative(self, driver, url):
        print("To validate user role update by project admin user negative")
        prefix = Utils.random_string(6)
        prefix_2 = Utils.random_string(6)
        Platform(driver).launch(url) \
            .click_create_account_link() \
    ...
    @pytest.mark.teamingRoleUpdateNegative
    def test_verify_user_role_update_by_read_admin_user_negative(self, driver, url):
        print("To validate user role update by project read admin user negative")
        prefix = Utils.random_string(6)
        prefix_2 = Utils.random_string(6)
        Platform(driver).launch(url) \
            .click_create_account_link() \
    ...
    @pytest.mark.teamingRoleUpdateNegative
    def test_verify_user_role_update_by_project_member_negative(self, driver, url):
        print("To validate user role update by project member user negative")
        prefix = Utils.random_string(6)
        Platform(driver).launch(url) \
            .click_create_account_link() \
            .enter_first_name(prefix + "test") \
